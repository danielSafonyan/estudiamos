...
export default function AccessSignUpp() {
    ...
    return (
         <form className="access-main-form" onSubmit={handleSubmit}>
            <h2 className="access-main-form-title">Create Account</h2>
            ...
            <input type="password" name="passCheck" value={inputState.passCheck} className="invalid" placeholder="repeat password" autoComplete="new-password" required onChange={handleChange}/>
